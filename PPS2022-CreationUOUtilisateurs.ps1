...
Invoke-WebRequest -UseBasicParsing -Uri "https://raw.githubusercontent.com/Jonathan28260/ProjetAnnuel_Powershell/main/PPS2022-NouveauxUtilisateurs.csv" -OutFile C:\Scripts\PPS2022-NouveauxUtilisateurs.csv
$UtilisateurAD = Import-csv C:\Scripts\PPS2022-NouveauxUtilisateurs.csv -Delimiter ";"
